...
OperatorUsageMap::OperatorUsageMap() {
    ...
    operator_usage_map.map["bound function"] =
        "\nbound function:\n"
        "    description:\n"
        "        foo {var|one>, var|two>, ...} #=>\n"
        "            statements ...\n\n"
    ...
    operator_usage_map.map[" > "] =
        ...
        "    description:\n"
        "        ket1 > ket2\n"
        "        test whether ket1 is greater than ket2\n"
        "        if either of the kets are not numbers, then return the empty ket\n"
        "        if the categories for the kets are different, again, we return the empty ket\n\n"
        "    examples:\n"
        "        |5> > |8>\n"
    ...
    operator_usage_map.map[" < "] =
        ...
        "    description:\n"
        "        ket1 < ket2\n"
        "        test whether ket1 is less than ket2\n"
        "        if either of the kets are not numbers, then return the empty ket\n"
        "        if the categories for the kets are different, again, we return the empty ket\n\n"
        "    examples:\n"
        "        |5> < |8>\n"
    ...
    operator_usage_map.map[" -- "] =
        ...
        "    description:\n"
        "        ket1 -- ket2\n"
        "        subtract the value of ket2 from ket1\n"
        "        we do our best to preserve categories\n"
        "        if one ket has a category, and the other doesn't then the result has that category\n"
        "        if ket1 and ket2 have different categories then return the empty ket |>\n"
        "        if ket1 and ket2 are 2D, then subtract them component-wise\n\n"
        "    examples:\n"
        "        |3> -- |5>\n"
        "            |-2>\n\n"
        "        |number: 3> -- |5>\n"
    ...
    operator_usage_map.map["supported-ops"] =
        "\nsupported-ops:\n"
        "    description:\n"
        "        supported-ops\n"
    ...
    operator_usage_map.map["if-then machine"] =
        "\nif-then machine:\n"
        "    description:\n"
        "        if-then machine\n"
    ...
    operator_usage_map.map["label descent"] =
        "\nlabel descent:\n"
        "    description:\n"
        "        label descent\n"
    ...
    operator_usage_map.map["|category: *>"] =
        "\n|category: *>:\n"
        "    description:\n"
        "        |category: *>\n"
    ...
    operator_usage_map.map["op-sequence"] =
        "\nop-sequence:\n"
        "    description:\n"
        "        sequence operator\n"
    ...
    operator_usage_map.map["transform"] =
        "\ntransform:\n"
        "    description:\n"
    ...
    operator_usage_map.map["superposition"] =
        "\nsuperposition:\n"
        "    description:\n"
        "        ket1 + ket2 + ... + ketn\n"
    ...
    operator_usage_map.map["weighted-pick-elt"] =
        "\nweighted-pick-elt:\n"
        "    description:\n"
    ...
    operator_usage_map.statement_prototypes["if-else"] =
        "if( $1 ):\n"
        "    $2\n"
        "else:\n"
        "    $3\n"
    ...
    operator_usage_map.statement_prototypes["for"] =
        "for( $1 ):\n"
        "    $2\n"
        "end:\n";

    operator_usage_map.statement_prototypes["sfor"] =
        "sfor( $1 ):\n"
        "    $2\n"
        "end:\n";

    operator_usage_map.statement_prototypes["while"] =
        "while( $1 ):\n"
        "    $2\n"
        "end:\n";
...
bool OperatorUsageMap::has_statement_prototype(const std::string& s) const {
    auto it = statement_prototypes.find(s);
...
OpUsageInfo* OperatorUsageMap::get_usage_info(const std::string& op)
{
    if (m_usage_info_map.find(op) == m_usage_info_map.end())
    {
        return NULL;
    }
    return m_usage_info_map[op];
}

std::string OperatorUsageMap::linkify_text(std::string text)  // NB: rather slow if using in real time!
{
    std::string result = text;
    for (const auto& iter : map)
    {
        std::string html_link = "<a href=\"" + iter.first + "\">" + iter.first + "</a>";
